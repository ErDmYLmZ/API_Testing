...
//        assertEquals("Checkout date is not matching","2021-05-07", json.getString("bookingdates.checkout"));
        ...
        softAssert.assertEquals(json.getString("bookingdates.checkin"), "2021-04-12", "Checkin date is not matching");
        softAssert.assertEquals(json.getString("bookingdates.checkout"), "2021-05-07", "Checkout date is not matching");
